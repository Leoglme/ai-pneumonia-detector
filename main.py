...
model = tf.keras.models.Sequential([
    tf.keras.layers.Conv2D(32, (3, 3), activation='relu', input_shape=(128, 128, 3)), # Couche de convolution avec 32 filtres, taille de filtre 3x3, et fonction d'activation ReLU
    ...
    tf.keras.layers.Dense(1, activation='sigmoid')                                   # Couche de sortie avec un neurone et activation sigmoïde pour la classification binaire
])
...
history = model.fit(
    ...
    epochs=15,                  # Nombre d'époques (périodes d'entraînement)
